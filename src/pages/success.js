                                ...
                                <form method="post" id="register-form">
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            ...
                                            <input type="name" className="form-control" id="" placeholder="Họ và Tên" readOnly/>
                                        </div>
                                        <div className="form-group col-md-12">
                                    ...
                                    <div className="form-group">
                                        <input type="text" className="form-control" id="" placeholder="Email" readOnly/>
                                    </div>

                                    <button>
                                        <a href="index.html" className="btn btn-danger ml-8 btn-success-playboy-green btn-success-playboy-green-block">Tôi đã thanh toán</a>
